...
type IOwnerService interface {
	...
	FindByUserId(ctx context.Context, userId auth.UserId) (*domain.Owner, error)
	Create(ctx context.Context, userId auth.UserId, ownerProfile domain.OwnerProfile) (*domain.Owner, error)
...
func (svc *ownerService) FindByUserId(ctx context.Context, userId auth.UserId) (*domain.Owner, error) {
	return svc.ownerRepository.FindByUserId(ctx, userId)
}

func (svc *ownerService) Create(ctx context.Context, userId auth.UserId, ownerProfile domain.OwnerProfile) (*domain.Owner, error) {
