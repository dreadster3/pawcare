...
func EncodeResponse(ctx context.Context, _ *message.Message, response interface{}) error {
...
func DecodeJSONMessage[T any](_ context.Context, msg *message.Message) (interface{}, error) {
	var request T
